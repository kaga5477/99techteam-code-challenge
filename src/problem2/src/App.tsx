...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-500 to-black flex items-center justify-center p-4 font-inter">
      <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md">
        ...
        <div className="flex justify-center m-4 relative">
          <button
            ...
            className="cursor-pointer p-3 bg-blue-500 text-white rounded-full shadow-lg hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 transition-all duration-200 ease-in-out transform hover:rotate-180"
        ...
        {exchangeRate !== null &&
          ...
          fromCurrency !== toCurrency && (
            <p className="text-center text-gray-700 text-2xl mb-4">
